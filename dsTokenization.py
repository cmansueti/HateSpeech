...
directory = os.fsencode('/home/R18cmansueti/DailyStormerTxtTest')
for file in os.listdir(directory):
    ...
    if filename.endswith(".txt"):
        ...
        s = ""
        filePath='/home/R18cmansueti/DailyStormerTxt/' + filename
        f = open(filePath, 'rU')
        for line in f:
            s+=" " +line.strip()
...
#print(tokenized_words_by_sentence_no_punc[:10])
        ...
        print("\nFirst 20 sentences after stops have been removed:")
